...
class MCUSimilarityCalculatorTest {
    ...
    class FamilySimilarityTests {
        ...
        void sameFamilyShouldHaveHighSimilarity() {
            double similarity = calculator.calculateSimilarity("STM32F103", "STM32F407");
        ...
        void identicalMcuShouldHaveSimilarityOne() {
            double similarity = calculator.calculateSimilarity("ATMEGA328P", "ATMEGA328P");
        ...
        void differentFamiliesShouldHaveLowerSimilarity() {
            double sameFam = calculator.calculateSimilarity("STM32F103", "STM32F407");
            double diffFam = calculator.calculateSimilarity("STM32F103", "ATMEGA328");
        ...
        void picFamilyMembersShouldMatch() {
            double similarity = calculator.calculateSimilarity("PIC16F877", "PIC18F4550");
        ...
        void mspFamilyMembersShouldMatch() {
            double similarity = calculator.calculateSimilarity("MSP430F5529", "MSP430G2553");
    ...
    class SeriesSimilarityTests {
        ...
        void sameSeriesShouldHaveHighSimilarity() {
            double similarity = calculator.calculateSimilarity("STM32F103C8", "STM32F103CB");
        ...
        void closeSeriesNumbersShouldBeMoreSimilar() {
            double close = calculator.calculateSimilarity("ATMEGA328", "ATMEGA328P");
            double far = calculator.calculateSimilarity("ATMEGA328", "ATMEGA2560");
        ...
        void veryDifferentSeriesShouldHaveLowerSimilarity() {
            double similarity = calculator.calculateSimilarity("STM32F103", "STM32H743");
    ...
    class FeatureSimilarityTests {
        ...
        void sameFeatureCodesShouldMatch() {
            double similarity = calculator.calculateSimilarity("ATMEGA328P", "ATTINY85P");
        ...
        void lowPowerVariantsShouldMatch() {
            double similarity = calculator.calculateSimilarity("STM32L476", "STM32L432");
    ...
    class EdgeCaseTests {
        ...
        void emptyStringsShouldReturnLowSimilarity() {
            double similarity = calculator.calculateSimilarity("", "ATMEGA328");
    ...
    class PropertyTests {
        ...
        void similarityShouldBeSymmetric() {
            double sim1 = calculator.calculateSimilarity("STM32F103", "ATMEGA328");
            double sim2 = calculator.calculateSimilarity("ATMEGA328", "STM32F103");
    ...
    class RealWorldTests {
        ...
        void arduinoCompatibleMcus() {
            ...
            double similarity = calculator.calculateSimilarity("ATMEGA328P", "ATMEGA328PB");
        ...
        void stm32BluePillVariants() {
            double similarity = calculator.calculateSimilarity("STM32F103C8T6", "STM32F103CBT6");
        ...
        void esp32FamilyVariants() {
            double similarity = calculator.calculateSimilarity("ESP32", "ESP32S2");
