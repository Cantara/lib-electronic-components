...
## Overview
AVXHandler manages AVX Corporation components including tantalum capacitors, ceramic MLCCs, film capacitors, supercapacitors, and RF components.

**Note**: AVX was acquired by Kyocera in 2019.
...
| Prefix | Description |
|--------|-------------|
| TAJx | Standard MnO2 tantalum |
| TPSx | Polymer tantalum |
...
| Code | EIA Size |
|------|----------|
| A | EIA-3216-12/Case A |
| B | EIA-3528-12/Case B |
| C | EIA-6032-15/Case C |
| D | EIA-7343-20/Case D |
| E | EIA-7343-31/Case E |
| V | EIA-7343-43/Case V |
| W | EIA-7360-38/Case W |
| X | EIA-7361-43/Case X |
| Y | EIA-7361-43/Case Y |
...
- Ceramic capacitors must have same size
