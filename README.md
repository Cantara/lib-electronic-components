![GitHub tag (latest SemVer)](https://img.shields.io/github/v/tag/Cantara/lib-electronic-components) [![Build Status](https://jenkins.cantara.no/job/Cantara%20lib-electronic-components/badge/icon)](https://jenkins.cantara.no/job/Cantara%20lib-electronic-components/) 
